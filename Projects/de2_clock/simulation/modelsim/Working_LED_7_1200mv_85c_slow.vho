...
-- led_second	=>  Location: PIN_T22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \current_state.TOGGLE_E~feeder_combout\ : std_logic;
...
SIGNAL \current_state.FUNC_SET~feeder_combout\ : std_logic;
...
SIGNAL \bcd_sec_d0[3]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \LessThan0~4_combout\ = (\LessThan0~1_combout\) # ((\LessThan0~3_combout\ & (!count_clk_400Hz(11) & \LessThan0~2_combout\)))
...
-- Equation(s):
-- \count_clk_400Hz[10]~50_combout\ = (((!\LessThan0~0_combout\ & !\LessThan0~4_combout\)) # (!\LessThan0~5_combout\)) # (!\reset_key~input_o\)
...
-- Equation(s):
-- \lcd_rs~0_combout\ = (!\current_state.HOLD~q\ & !\current_state.TOGGLE_E~q\)
...
\current_state.TOGGLE_E~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \current_state.TOGGLE_E~feeder_combout\ = \lcd_rs~0_combout\
...
PORT MAP (
	...
	combout => \current_state.TOGGLE_E~feeder_combout\);
...
PORT MAP (
	...
	d => \current_state.TOGGLE_E~feeder_combout\,
...
PORT MAP (
	dataa => \current_state.HOLD~q\,
	datab => \current_state.TOGGLE_E~q\,
	datac => \next_state.RESET3~q\,
	datad => \current_state.RESET2~q\,
...
-- Equation(s):
-- \Selector11~0_combout\ = (\current_state.RESET3~q\) # ((\next_state.FUNC_SET~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
-- Equation(s):
-- \current_state~59_combout\ = (\next_state.FUNC_SET~q\ & \current_state.HOLD~q\)
...
\current_state.FUNC_SET~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \current_state.FUNC_SET~feeder_combout\ = \current_state~59_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \current_state~59_combout\,
	combout => \current_state.FUNC_SET~feeder_combout\);
...
PORT MAP (
	clk => \clk_400Hz~clkctrl_outclk\,
	d => \current_state.FUNC_SET~feeder_combout\,
	clrn => \reset_key~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Selector27~0_combout\ = (\current_state.FUNC_SET~q\) # ((\next_state.DISPLAY_OFF~q\ & ((\current_state.TOGGLE_E~q\) # (\current_state.HOLD~q\))))
...
PORT MAP (
	...
	datad => \current_state.FUNC_SET~q\,
...
-- Equation(s):
-- \current_state~58_combout\ = (\current_state.HOLD~q\ & \next_state.DISPLAY_OFF~q\)
...
-- Equation(s):
-- \Selector28~0_combout\ = (\current_state.DISPLAY_OFF~q\) # ((\next_state.DISPLAY_CLEAR~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
-- Equation(s):
-- \current_state~56_combout\ = (\current_state.HOLD~q\ & \next_state.DISPLAY_CLEAR~q\)
...
-- Equation(s):
-- \Selector13~0_combout\ = (\current_state.DISPLAY_ON~q\) # ((\next_state.MODE_SET~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
PORT MAP (
	...
	datad => \current_state.DISPLAY_ON~q\,
...
-- Equation(s):
-- \current_state~54_combout\ = (\current_state.HOLD~q\ & \next_state.MODE_SET~q\)
...
-- Equation(s):
-- \Selector21~0_combout\ = (\current_state.WRITE_CHAR7~q\) # ((\next_state.WRITE_CHAR8~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
-- Equation(s):
-- \current_state~53_combout\ = (\current_state.HOLD~q\ & \next_state.WRITE_CHAR8~q\)
...
-- Equation(s):
-- \Selector22~0_combout\ = (\current_state.WRITE_CHAR8~q\) # ((\next_state.WRITE_CHAR9~q\ & ((\current_state.TOGGLE_E~q\) # (\current_state.HOLD~q\))))
...
-- Equation(s):
-- \current_state~49_combout\ = (\current_state.HOLD~q\ & \next_state.WRITE_CHAR10~q\)
...
-- Equation(s):
-- \Selector24~0_combout\ = (\current_state.WRITE_CHAR10~q\) # ((\next_state.RETURN_HOME~q\ & ((\current_state.TOGGLE_E~q\) # (\current_state.HOLD~q\))))
...
-- Equation(s):
-- \Selector15~0_combout\ = (\current_state.WRITE_CHAR1~q\) # ((\next_state.WRITE_CHAR2~q\ & ((\current_state.TOGGLE_E~q\) # (\current_state.HOLD~q\))))
...
PORT MAP (
	...
	datad => \current_state.WRITE_CHAR1~q\,
...
PORT MAP (
	...
	datad => \current_state.WRITE_CHAR2~q\,
...
-- Equation(s):
-- \current_state~46_combout\ = (\current_state.HOLD~q\ & \next_state.WRITE_CHAR3~q\)
...
-- Equation(s):
-- \Selector17~0_combout\ = (\current_state.WRITE_CHAR3~q\) # ((\next_state.WRITE_CHAR4~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
PORT MAP (
	dataa => \current_state.HOLD~q\,
	datab => \current_state.WRITE_CHAR3~q\,
...
PORT MAP (
	dataa => \current_state.HOLD~q\,
	datab => \current_state.WRITE_CHAR4~q\,
...
-- Equation(s):
-- \Selector19~0_combout\ = (\current_state.WRITE_CHAR5~q\) # ((\next_state.WRITE_CHAR6~q\ & ((\current_state.TOGGLE_E~q\) # (\current_state.HOLD~q\))))
...
-- Equation(s):
-- \Selector20~0_combout\ = (\current_state.WRITE_CHAR6~q\) # ((\next_state.WRITE_CHAR7~q\ & ((\current_state.HOLD~q\) # (\current_state.TOGGLE_E~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \current_state.WRITE_CHAR6~q\,
	datab => \current_state.HOLD~q\,
...
-- Equation(s):
-- \LessThan1~1_combout\ = (!count_clk_10Hz(2) & (!count_clk_10Hz(3) & ((!count_clk_10Hz(0)) # (!count_clk_10Hz(1)))))
...
-- pragma translate_on
PORT MAP (
	dataa => count_clk_10Hz(1),
	datab => count_clk_10Hz(2),
	datac => count_clk_10Hz(3),
...
-- Equation(s):
-- \count_clk_10Hz[7]~22_combout\ = count_clk_10Hz(7) $ (\count_clk_10Hz[6]~21\)
...
-- Equation(s):
-- \bcd_tsec~3_combout\ = (bcd_tsec(2) & (bcd_tsec(1) & (!bcd_tsec(3) & bcd_tsec(0)))) # (!bcd_tsec(2) & (!bcd_tsec(1) & (bcd_tsec(3) & !bcd_tsec(0))))
...
-- Equation(s):
-- \bcd_tsec~1_combout\ = (!bcd_tsec(3) & (bcd_tsec(0) $ (bcd_tsec(1))))
...
-- Equation(s):
-- \LessThan2~0_combout\ = (bcd_tsec(3) & ((bcd_tsec(2)) # ((bcd_tsec(0)) # (bcd_tsec(1)))))
...
-- Equation(s):
-- \bcd_sec_d0~2_combout\ = (!bcd_sec_d0(3) & (bcd_sec_d0(2) $ (((bcd_sec_d0(1) & bcd_sec_d0(0))))))
...
-- Equation(s):
-- \bcd_sec_d0~3_combout\ = (bcd_sec_d0(3) & (!bcd_sec_d0(1) & (!bcd_sec_d0(0) & !bcd_sec_d0(2)))) # (!bcd_sec_d0(3) & (bcd_sec_d0(1) & (bcd_sec_d0(0) & bcd_sec_d0(2))))
...
\bcd_sec_d0[3]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \bcd_sec_d0[3]~feeder_combout\ = \bcd_sec_d0~3_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \bcd_sec_d0~3_combout\,
	combout => \bcd_sec_d0[3]~feeder_combout\);
...
-- Equation(s):
-- \LessThan3~0_combout\ = ((!bcd_sec_d0(0) & (!bcd_sec_d0(2) & !bcd_sec_d0(1)))) # (!bcd_sec_d0(3))
...
-- Equation(s):
-- \bcd_sec_d1~0_combout\ = (!bcd_sec_d1(0) & ((!bcd_sec_d1(1)) # (!bcd_sec_d1(2))))
...
-- Equation(s):
-- \bcd_min_d0~4_combout\ = (bcd_min_d0(2) & (bcd_min_d0(0) & (!bcd_min_d0(3) & bcd_min_d0(1)))) # (!bcd_min_d0(2) & (!bcd_min_d0(0) & (bcd_min_d0(3) & !bcd_min_d0(1))))
...
-- Equation(s):
-- \LessThan4~0_combout\ = ((!bcd_sec_d1(1) & !bcd_sec_d1(0))) # (!bcd_sec_d1(2))
...
-- Equation(s):
-- \bcd_min_d0[3]~1_combout\ = (\LessThan2~0_combout\ & (!\LessThan4~0_combout\ & !\LessThan3~0_combout\))
...
-- Equation(s):
-- \bcd_min_d0~2_combout\ = (!bcd_min_d0(3) & (bcd_min_d0(0) $ (bcd_min_d0(1))))
...
-- Equation(s):
-- \bcd_min_d0~3_combout\ = (!bcd_min_d0(3) & (bcd_min_d0(2) $ (((bcd_min_d0(1) & bcd_min_d0(0))))))
...
-- Equation(s):
-- \Selector8~2_combout\ = (\current_state.WRITE_CHAR7~q\ & ((bcd_sec_d1(0)) # ((\current_state.WRITE_CHAR5~q\ & bcd_min_d0(0))))) # (!\current_state.WRITE_CHAR7~q\ & (\current_state.WRITE_CHAR5~q\ & ((bcd_min_d0(0)))))
...
-- Equation(s):
-- \bcd_min_d1~2_combout\ = (!bcd_min_d1(0) & ((!bcd_min_d1(1)) # (!bcd_min_d1(2))))
...
-- Equation(s):
-- \LessThan5~0_combout\ = ((!bcd_min_d0(0) & (!bcd_min_d0(1) & !bcd_min_d0(2)))) # (!bcd_min_d0(3))
...
-- Equation(s):
-- \bcd_min_d1[3]~1_combout\ = (\LessThan2~0_combout\ & (!\LessThan3~0_combout\ & (!\LessThan4~0_combout\ & !\LessThan5~0_combout\)))
...
-- Equation(s):
-- \bcd_min_d1~3_combout\ = (!bcd_min_d1(2) & (bcd_min_d1(0) $ (bcd_min_d1(1))))
...
-- Equation(s):
-- \process_2~3_combout\ = (\process_2~2_combout\ & ((!\process_2~1_combout\) # (!\process_2~0_combout\)))
...
-- Equation(s):
-- \process_2~4_combout\ = (bcd_hr_d0(1) & bcd_hr_d0(0))
...
-- Equation(s):
-- \bcd_hr_d0~4_combout\ = (\process_2~3_combout\ & (bcd_hr_d0(3) $ (((bcd_hr_d0(2) & \process_2~4_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \process_2~3_combout\,
	datab => bcd_hr_d0(2),
	datac => bcd_hr_d0(3),
	datad => \process_2~4_combout\,
...
-- Equation(s):
-- \bcd_hr_d1[2]~13_combout\ = bcd_hr_d1(2) $ (((bcd_hr_d1(1) & (bcd_hr_d1(0) & !\bcd_hr_d1[3]~7_combout\))))
...
-- Equation(s):
-- \process_2~0_combout\ = (!bcd_hr_d1(3) & (!bcd_hr_d1(2) & (bcd_hr_d0(1) & bcd_hr_d0(0))))
...
-- Equation(s):
-- \bcd_hr_d0~2_combout\ = (\process_2~2_combout\ & (!bcd_hr_d0(0) & ((!\process_2~1_combout\) # (!\process_2~0_combout\))))
...
-- Equation(s):
-- \bcd_hr_d0~5_combout\ = (\process_2~3_combout\ & (bcd_hr_d0(2) $ (((bcd_hr_d0(0) & bcd_hr_d0(1))))))
...
-- Equation(s):
-- \process_2~1_combout\ = (!bcd_hr_d0(2) & (bcd_hr_d1(1) & (!bcd_hr_d1(0) & !bcd_hr_d0(3))))
...
-- Equation(s):
-- \process_2~5_combout\ = (\process_2~1_combout\ & \process_2~0_combout\)
...
-- Equation(s):
-- \bcd_hr_d1[0]~6_combout\ = bcd_hr_d1(0) $ (((!\process_2~5_combout\ & (\bcd_min_d1[3]~1_combout\ & !\bcd_hr_d1[0]~12_combout\))))
...
PORT MAP (
	dataa => \process_2~5_combout\,
	datab => \bcd_min_d1[3]~1_combout\,
	datac => bcd_hr_d1(0),
	datad => \bcd_hr_d1[0]~12_combout\,
...
-- Equation(s):
-- \Selector8~0_combout\ = (bcd_hr_d1(0) & \current_state.WRITE_CHAR1~q\)
...
-- Equation(s):
-- \Selector8~1_combout\ = (\current_state.WRITE_CHAR8~q\ & ((bcd_sec_d0(0)) # ((\current_state.WRITE_CHAR10~q\ & bcd_tsec(0))))) # (!\current_state.WRITE_CHAR8~q\ & (((\current_state.WRITE_CHAR10~q\ & bcd_tsec(0)))))
...
-- Equation(s):
-- \Selector8~5_combout\ = (\Selector8~2_combout\) # ((\Selector8~0_combout\) # ((\Selector8~1_combout\) # (\Selector8~4_combout\)))
...
-- Equation(s):
-- \Selector7~1_combout\ = (\current_state.WRITE_CHAR5~q\ & ((bcd_min_d0(1)) # ((bcd_sec_d1(1) & \current_state.WRITE_CHAR7~q\)))) # (!\current_state.WRITE_CHAR5~q\ & (bcd_sec_d1(1) & (\current_state.WRITE_CHAR7~q\)))
...
-- Equation(s):
-- \Selector7~0_combout\ = (\current_state.WRITE_CHAR10~q\ & ((bcd_tsec(1)) # ((\current_state.WRITE_CHAR8~q\ & bcd_sec_d0(1))))) # (!\current_state.WRITE_CHAR10~q\ & (\current_state.WRITE_CHAR8~q\ & (bcd_sec_d0(1))))
...
-- Equation(s):
-- \Selector1~4_combout\ = (!\current_state.WRITE_CHAR3~q\ & (!\current_state.WRITE_CHAR6~q\ & !\current_state.WRITE_CHAR9~q\))
...
PORT MAP (
	datab => \current_state.WRITE_CHAR3~q\,
	datac => \current_state.WRITE_CHAR6~q\,
...
-- Equation(s):
-- \Selector7~4_combout\ = ((bcd_hr_d1(1) & \current_state.WRITE_CHAR1~q\)) # (!\Selector1~4_combout\)
...
-- Equation(s):
-- \Selector7~5_combout\ = (\Selector7~1_combout\) # ((\Selector7~3_combout\) # ((\Selector7~0_combout\) # (\Selector7~4_combout\)))
...
-- Equation(s):
-- \Selector6~1_combout\ = (\current_state.WRITE_CHAR8~q\ & ((bcd_sec_d0(2)) # ((\current_state.WRITE_CHAR10~q\ & bcd_tsec(2))))) # (!\current_state.WRITE_CHAR8~q\ & (\current_state.WRITE_CHAR10~q\ & (bcd_tsec(2))))
...
-- Equation(s):
-- \Selector6~5_combout\ = (\Selector6~4_combout\) # ((\Selector6~0_combout\) # ((\Selector6~2_combout\) # (\Selector6~1_combout\)))
...
-- Equation(s):
-- \Selector5~4_combout\ = (\current_state.RESET2~q\) # ((\current_state.FUNC_SET~q\) # ((\current_state.RESET3~q\) # (!\Selector1~4_combout\)))
...
-- Equation(s):
-- \Selector5~1_combout\ = (\current_state.WRITE_CHAR5~q\ & ((bcd_min_d0(3)) # ((bcd_hr_d0(3) & \current_state.WRITE_CHAR2~q\)))) # (!\current_state.WRITE_CHAR5~q\ & (((bcd_hr_d0(3) & \current_state.WRITE_CHAR2~q\))))
...
-- Equation(s):
-- \Selector5~2_combout\ = (\current_state.DISPLAY_ON~q\) # ((\current_state.DISPLAY_OFF~q\) # ((bcd_hr_d1(3) & \current_state.WRITE_CHAR1~q\)))
...
PORT MAP (
	...
	datac => \current_state.DISPLAY_ON~q\,
	datad => \current_state.DISPLAY_OFF~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \current_state.RESET1~q\,
	datab => data_bus_value(3),
	datac => \lcd_rs~0_combout\,
...
-- Equation(s):
-- \Selector5~0_combout\ = (bcd_sec_d0(3) & ((\current_state.WRITE_CHAR8~q\) # ((\current_state.WRITE_CHAR10~q\ & bcd_tsec(3))))) # (!bcd_sec_d0(3) & (((\current_state.WRITE_CHAR10~q\ & bcd_tsec(3)))))
...
-- Equation(s):
-- \Selector5~5_combout\ = (!\Selector5~4_combout\ & (!\Selector5~1_combout\ & (!\Selector5~3_combout\ & !\Selector5~0_combout\)))
...
-- Equation(s):
-- \WideOr6~0_combout\ = (!\current_state.MODE_SET~q\ & (!\current_state.TOGGLE_E~q\ & (!\current_state.HOLD~q\ & !\current_state.RETURN_HOME~q\)))
...
-- Equation(s):
-- \Selector1~1_combout\ = (\current_state.WRITE_CHAR2~q\) # ((\current_state.WRITE_CHAR3~q\) # ((\current_state.WRITE_CHAR6~q\) # (\current_state.WRITE_CHAR9~q\)))
...
-- Equation(s):
-- \Selector1~2_combout\ = (\current_state.WRITE_CHAR5~q\) # ((\current_state.WRITE_CHAR8~q\) # ((\current_state.WRITE_CHAR4~q\) # (\current_state.WRITE_CHAR7~q\)))
...
PORT MAP (
	dataa => \current_state.WRITE_CHAR5~q\,
	datab => \current_state.WRITE_CHAR8~q\,
	datac => \current_state.WRITE_CHAR4~q\,
	datad => \current_state.WRITE_CHAR7~q\,
...
-- Equation(s):
-- \Selector1~3_combout\ = (\current_state.WRITE_CHAR10~q\) # ((\Selector1~1_combout\) # ((\Selector1~2_combout\) # (\Selector1~0_combout\)))
...
-- Equation(s):
-- \Mux6~0_combout\ = (bcd_tsec(2) & (!bcd_tsec(1) & (bcd_tsec(0) $ (!bcd_tsec(3))))) # (!bcd_tsec(2) & (bcd_tsec(0) & (bcd_tsec(1) $ (!bcd_tsec(3)))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (bcd_tsec(1) & ((bcd_tsec(0) & ((bcd_tsec(3)))) # (!bcd_tsec(0) & (bcd_tsec(2))))) # (!bcd_tsec(1) & (bcd_tsec(2) & (bcd_tsec(0) $ (bcd_tsec(3)))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (bcd_tsec(2) & (bcd_tsec(3) & ((bcd_tsec(1)) # (!bcd_tsec(0))))) # (!bcd_tsec(2) & (!bcd_tsec(0) & (bcd_tsec(1) & !bcd_tsec(3))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (bcd_tsec(0) & (bcd_tsec(2) $ ((!bcd_tsec(1))))) # (!bcd_tsec(0) & ((bcd_tsec(2) & (!bcd_tsec(1) & !bcd_tsec(3))) # (!bcd_tsec(2) & (bcd_tsec(1) & bcd_tsec(3)))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (bcd_tsec(0) & (bcd_tsec(3) $ (((bcd_tsec(1)) # (!bcd_tsec(2)))))) # (!bcd_tsec(0) & (!bcd_tsec(2) & (bcd_tsec(1) & !bcd_tsec(3))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (bcd_tsec(0) & (!bcd_tsec(3) & (bcd_tsec(2) $ (!bcd_tsec(1))))) # (!bcd_tsec(0) & (!bcd_tsec(1) & (bcd_tsec(2) $ (!bcd_tsec(3)))))
...
-- Equation(s):
-- \Mux13~0_combout\ = (bcd_sec_d0(2) & (!bcd_sec_d0(1) & (bcd_sec_d0(3) $ (!bcd_sec_d0(0))))) # (!bcd_sec_d0(2) & (bcd_sec_d0(0) & (bcd_sec_d0(3) $ (!bcd_sec_d0(1)))))
...
-- Equation(s):
-- \Mux12~0_combout\ = (bcd_sec_d0(3) & ((bcd_sec_d0(0) & ((bcd_sec_d0(1)))) # (!bcd_sec_d0(0) & (bcd_sec_d0(2))))) # (!bcd_sec_d0(3) & (bcd_sec_d0(2) & (bcd_sec_d0(1) $ (bcd_sec_d0(0)))))
...
-- Equation(s):
-- \Mux11~0_combout\ = (bcd_sec_d0(2) & (bcd_sec_d0(3) & ((bcd_sec_d0(1)) # (!bcd_sec_d0(0))))) # (!bcd_sec_d0(2) & (!bcd_sec_d0(3) & (bcd_sec_d0(1) & !bcd_sec_d0(0))))
...
-- Equation(s):
-- \Mux10~0_combout\ = (bcd_sec_d0(0) & (bcd_sec_d0(2) $ (((!bcd_sec_d0(1)))))) # (!bcd_sec_d0(0) & ((bcd_sec_d0(2) & (!bcd_sec_d0(3) & !bcd_sec_d0(1))) # (!bcd_sec_d0(2) & (bcd_sec_d0(3) & bcd_sec_d0(1)))))
...
-- Equation(s):
-- \Mux9~0_combout\ = (bcd_sec_d0(1) & (((!bcd_sec_d0(3) & bcd_sec_d0(0))))) # (!bcd_sec_d0(1) & ((bcd_sec_d0(2) & (!bcd_sec_d0(3))) # (!bcd_sec_d0(2) & ((bcd_sec_d0(0))))))
...
-- Equation(s):
-- \Mux8~0_combout\ = (bcd_sec_d0(2) & (bcd_sec_d0(0) & (bcd_sec_d0(3) $ (bcd_sec_d0(1))))) # (!bcd_sec_d0(2) & (!bcd_sec_d0(3) & ((bcd_sec_d0(1)) # (bcd_sec_d0(0)))))
...
-- Equation(s):
-- \Mux7~0_combout\ = (bcd_sec_d0(0) & (!bcd_sec_d0(3) & (bcd_sec_d0(2) $ (!bcd_sec_d0(1))))) # (!bcd_sec_d0(0) & (!bcd_sec_d0(1) & (bcd_sec_d0(2) $ (!bcd_sec_d0(3)))))
...
-- Equation(s):
-- \Mux27~0_combout\ = (bcd_min_d0(3) & (bcd_min_d0(0) & (bcd_min_d0(2) $ (bcd_min_d0(1))))) # (!bcd_min_d0(3) & (!bcd_min_d0(1) & (bcd_min_d0(2) $ (bcd_min_d0(0)))))
...
-- Equation(s):
-- \Mux26~0_combout\ = (bcd_min_d0(3) & ((bcd_min_d0(0) & ((bcd_min_d0(1)))) # (!bcd_min_d0(0) & (bcd_min_d0(2))))) # (!bcd_min_d0(3) & (bcd_min_d0(2) & (bcd_min_d0(0) $ (bcd_min_d0(1)))))
...
-- Equation(s):
-- \Mux25~0_combout\ = (bcd_min_d0(3) & (bcd_min_d0(2) & ((bcd_min_d0(1)) # (!bcd_min_d0(0))))) # (!bcd_min_d0(3) & (!bcd_min_d0(2) & (!bcd_min_d0(0) & bcd_min_d0(1))))
...
-- Equation(s):
-- \Mux24~0_combout\ = (bcd_min_d0(0) & ((bcd_min_d0(2) $ (!bcd_min_d0(1))))) # (!bcd_min_d0(0) & ((bcd_min_d0(3) & (!bcd_min_d0(2) & bcd_min_d0(1))) # (!bcd_min_d0(3) & (bcd_min_d0(2) & !bcd_min_d0(1)))))
...
-- Equation(s):
-- \Mux23~0_combout\ = (bcd_min_d0(1) & (!bcd_min_d0(3) & ((bcd_min_d0(0))))) # (!bcd_min_d0(1) & ((bcd_min_d0(2) & (!bcd_min_d0(3))) # (!bcd_min_d0(2) & ((bcd_min_d0(0))))))
...
-- Equation(s):
-- \Mux22~0_combout\ = (bcd_min_d0(2) & (bcd_min_d0(0) & (bcd_min_d0(3) $ (bcd_min_d0(1))))) # (!bcd_min_d0(2) & (!bcd_min_d0(3) & ((bcd_min_d0(0)) # (bcd_min_d0(1)))))
...
-- Equation(s):
-- \Mux21~0_combout\ = (bcd_min_d0(0) & (!bcd_min_d0(3) & (bcd_min_d0(2) $ (!bcd_min_d0(1))))) # (!bcd_min_d0(0) & (!bcd_min_d0(1) & (bcd_min_d0(3) $ (!bcd_min_d0(2)))))
...
-- Equation(s):
-- \Mux34~0_combout\ = (!bcd_min_d1(1) & (bcd_min_d1(2) $ (bcd_min_d1(0))))
...
-- Equation(s):
-- \Mux33~0_combout\ = (bcd_min_d1(2) & (bcd_min_d1(1) $ (bcd_min_d1(0))))
...
-- Equation(s):
-- \Mux32~0_combout\ = (bcd_min_d1(1) & (!bcd_min_d1(2) & !bcd_min_d1(0)))
...
-- Equation(s):
-- \Mux31~0_combout\ = (bcd_min_d1(1) & (bcd_min_d1(2) & bcd_min_d1(0))) # (!bcd_min_d1(1) & (bcd_min_d1(2) $ (bcd_min_d1(0))))
...
-- Equation(s):
-- \Mux29~0_combout\ = (bcd_min_d1(1) & ((bcd_min_d1(0)) # (!bcd_min_d1(2)))) # (!bcd_min_d1(1) & (!bcd_min_d1(2) & bcd_min_d1(0)))
...
-- Equation(s):
-- \Mux28~0_combout\ = (bcd_min_d1(1) & (bcd_min_d1(2) & bcd_min_d1(0))) # (!bcd_min_d1(1) & (!bcd_min_d1(2)))
...
-- Equation(s):
-- \Mux41~0_combout\ = (bcd_hr_d0(3) & (bcd_hr_d0(0) & (bcd_hr_d0(1) $ (bcd_hr_d0(2))))) # (!bcd_hr_d0(3) & (!bcd_hr_d0(1) & (bcd_hr_d0(0) $ (bcd_hr_d0(2)))))
...
-- Equation(s):
-- \Mux40~0_combout\ = (bcd_hr_d0(1) & ((bcd_hr_d0(0) & (bcd_hr_d0(3))) # (!bcd_hr_d0(0) & ((bcd_hr_d0(2)))))) # (!bcd_hr_d0(1) & (bcd_hr_d0(2) & (bcd_hr_d0(0) $ (bcd_hr_d0(3)))))
...
-- Equation(s):
-- \Mux39~0_combout\ = (bcd_hr_d0(3) & (bcd_hr_d0(2) & ((bcd_hr_d0(1)) # (!bcd_hr_d0(0))))) # (!bcd_hr_d0(3) & (bcd_hr_d0(1) & (!bcd_hr_d0(0) & !bcd_hr_d0(2))))
...
-- Equation(s):
-- \Mux38~0_combout\ = (bcd_hr_d0(0) & (bcd_hr_d0(1) $ (((!bcd_hr_d0(2)))))) # (!bcd_hr_d0(0) & ((bcd_hr_d0(1) & (bcd_hr_d0(3) & !bcd_hr_d0(2))) # (!bcd_hr_d0(1) & (!bcd_hr_d0(3) & bcd_hr_d0(2)))))
...
-- Equation(s):
-- \Mux36~0_combout\ = (bcd_hr_d0(2) & (bcd_hr_d0(0) & (bcd_hr_d0(3) $ (bcd_hr_d0(1))))) # (!bcd_hr_d0(2) & (!bcd_hr_d0(3) & ((bcd_hr_d0(1)) # (bcd_hr_d0(0)))))
...
-- Equation(s):
-- \Mux35~0_combout\ = (bcd_hr_d0(0) & (!bcd_hr_d0(3) & (bcd_hr_d0(2) $ (!bcd_hr_d0(1))))) # (!bcd_hr_d0(0) & (!bcd_hr_d0(1) & (bcd_hr_d0(2) $ (!bcd_hr_d0(3)))))
...
-- Equation(s):
-- \Mux48~0_combout\ = (bcd_hr_d1(3) & (bcd_hr_d1(0) & (bcd_hr_d1(2) $ (bcd_hr_d1(1))))) # (!bcd_hr_d1(3) & (!bcd_hr_d1(1) & (bcd_hr_d1(2) $ (bcd_hr_d1(0)))))
...
-- Equation(s):
-- \Mux46~0_combout\ = (bcd_hr_d1(3) & (bcd_hr_d1(2) & ((bcd_hr_d1(1)) # (!bcd_hr_d1(0))))) # (!bcd_hr_d1(3) & (!bcd_hr_d1(2) & (!bcd_hr_d1(0) & bcd_hr_d1(1))))
...
-- Equation(s):
-- \Mux45~0_combout\ = (bcd_hr_d1(0) & ((bcd_hr_d1(2) $ (!bcd_hr_d1(1))))) # (!bcd_hr_d1(0) & ((bcd_hr_d1(3) & (!bcd_hr_d1(2) & bcd_hr_d1(1))) # (!bcd_hr_d1(3) & (bcd_hr_d1(2) & !bcd_hr_d1(1)))))
...
-- Equation(s):
-- \Mux44~0_combout\ = (bcd_hr_d1(1) & (!bcd_hr_d1(3) & ((bcd_hr_d1(0))))) # (!bcd_hr_d1(1) & ((bcd_hr_d1(2) & (!bcd_hr_d1(3))) # (!bcd_hr_d1(2) & ((bcd_hr_d1(0))))))
...
-- Equation(s):
-- \Mux42~0_combout\ = (bcd_hr_d1(0) & (!bcd_hr_d1(3) & (bcd_hr_d1(2) $ (!bcd_hr_d1(1))))) # (!bcd_hr_d1(0) & (!bcd_hr_d1(1) & (bcd_hr_d1(3) $ (!bcd_hr_d1(2)))))
