## Generated SDC file "spi_loopback.out.sdc"
...
create_clock -name {m_clk_i} -period 8.000 -waveform { 0.000 4.000 } [get_ports { m_clk_i }]
create_clock -name {s_clk_i} -period 8.000 -waveform { 0.000 4.000 } [get_ports { s_clk_i }]
...
set_clock_latency -source   4.000 [get_clocks {s_clk_i}]
set_clock_latency -source   4.000 [get_clocks {s_spi_sck_i}]
set_clock_latency -source   4.000 [get_clocks {m_clk_i}]
...
set_clock_uncertainty -rise_from [get_clocks {m_clk_i}] -rise_to [get_clocks {m_clk_i}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {m_clk_i}] -fall_to [get_clocks {m_clk_i}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {m_clk_i}] -rise_to [get_clocks {m_clk_i}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {m_clk_i}] -fall_to [get_clocks {m_clk_i}]  0.020  
