## Generated SDC file "SPI_Comms.out.sdc"
...
create_clock -name {s_spi_sck_i} -period 5.000 -waveform { 0.000 2.500 } [get_ports { s_spi_sck_i }]
create_clock -name {s_clk_i} -period 5.000 -waveform { 0.000 2.500 } [get_ports { s_clk_i }]
